...
% ============================================================
\FVDsection{Basis --- een regressiemodel lezen}
% ============================================================
...
% ============================================================
\FVDsection{Verdieping --- van dataset naar model}
% ============================================================
...
% ============================================================
\FVDsection{Gevorderd --- modelkeuze en kritiek}
% ============================================================
...
\begin{itemize}
  \item \textbf{Parameters interpreteren} --- $a$, $b$ en eenheden correct lezen;
  \item \textbf{Voorspellen met een model} --- een regressiemodel gebruiken;
  \item \textbf{Interpolatie of extrapolatie?} --- het toepassingsgebied bewaken;
  \item \textbf{Groei van een jonge plant} --- van dataset naar regressiemodel;
  \item \textbf{Hoogte en temperatuur} --- een STEM-dataset volledig analyseren;
  \item \textbf{Wanneer heeft het intercept betekenis?} --- parameters kritisch interpreteren;
  \item \textbf{Kalibratie van een oplossing} --- regressie als wetenschappelijk model gebruiken;
  \item \textbf{Een model dat te ver wordt doorgetrokken} --- extrapolatie kritisch beoordelen.
\end{itemize}

De \oefB-oefeningen leggen de noodzakelijke technische basis.
De \oefU-oefeningen met \ESS zijn eveneens essentieel omdat het
leerplandoel op \textbf{analyseren} staat: leerlingen moeten bij nieuwe
gegevens zelf grafiek, correlatie, regressiemodel en context met elkaar
