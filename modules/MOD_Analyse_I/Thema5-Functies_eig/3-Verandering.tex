...
Je kunt:
\begin{itemize}
  \item uit een grafiek aflezen waar een functie stijgt, daalt of constant is;
  \item lokale maxima en minima herkennen;
  \item functiewaarden en verschillen tussen functiewaarden vergelijken;
  \item grafieken en tabellen interpreteren.
\end{itemize}
\end{voorkennis}
...
\begin{itemize}
  \item onderscheid maken tussen stijgen/dalen en de manier waarop die stijging/daling verandert;
  \item constante, toenemende en afnemende stijging grafisch herkennen en beschrijven;
  \item constante, toenemende en afnemende daling grafisch herkennen en beschrijven;
  \item veranderingen vergelijken met behulp van gelijke stappen in de invoer;
  \item uit een tabel, grafiek of context afleiden hoe de verandering evolueert;
  \item vanuit gegeven veranderingskenmerken een mogelijke grafiek schetsen;
  \item uitspraken over verandering kritisch beoordelen en motiveren;
  \item verandering betekenisvol interpreteren in STEM-contexten.
\end{itemize}
\end{leerdoelen}
