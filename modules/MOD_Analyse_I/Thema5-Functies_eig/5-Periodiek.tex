...
\begin{voorkennis}
\item Je kunt grafieken lezen, domein en bereik bepalen, extrema herkennen en
functiewaarden uit een grafiek of tabel aflezen.
\end{voorkennis}

\begin{leerdoelen}

    \item Je kunt periodiek gedrag herkennen en beschrijven aan de hand van grafieken, tabellen en concrete contexten.
  
    \item Je kunt de periode van een periodieke functie bepalen aan de hand van haar grafiek.
  
    \item Je kunt uitleggen waarom een veelvoud van een periode ook een periode kan zijn, maar niet noodzakelijk de fundamentele periode is.
  
    \item Je kunt bij een oscillerende functie de amplitude bepalen aan de hand van de maximale en minimale functiewaarde.
  
    \item Je kunt de middenwaarde bepalen en de bijbehorende middenlijn in de grafiek herkennen.
  
    \item Je kunt de grafiek van een periodieke functie vanuit één volledige periode verder reconstrueren.
  
    \item Je kunt de periode, amplitude en middenwaarde van een periodieke functie interpreteren binnen een betekenisvolle STEM-context.
  
    \item Je kunt het onderscheid uitleggen tussen de periode als maat voor de horizontale herhaling en de amplitude als maat voor de verticale uitwijking.
