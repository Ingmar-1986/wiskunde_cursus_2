...
\begin{voorkennis}
    ...
    \item Je kunt punten en grafieken in een assenstelsel interpreteren.
  
    \item Je kunt functiewaarden zoals \(f(a)\) en \(f(-a)\) bepalen.
  
    \item Je kunt waarden invullen in een functievoorschrift en de verkregen uitdrukking vereenvoudigen.
  
    \item Je kunt het domein en grafische kenmerken van een functie onderzoeken.
  
  \end{voorkennis}
  
  \begin{leerdoelen}
  
    \item Je kunt symmetrie ten opzichte van de \(y\)-as en symmetrie ten opzichte van de oorsprong herkennen in een grafiek.
  
    \item Je kunt het verband uitleggen tussen de voorwaarde \(f(-x)=f(x)\), symmetrie ten opzichte van de \(y\)-as en een even functie.
  
    \item Je kunt het verband uitleggen tussen de voorwaarde \(f(-x)=-f(x)\), symmetrie ten opzichte van de oorsprong en een oneven functie.
  
    \item Je kunt aan de hand van een functievoorschrift onderzoeken of een functie even, oneven of geen van beide is.
  
    \item Je kunt symmetrie gebruiken om ontbrekende delen of punten van een grafiek te reconstrueren.
  
    \item Je kunt uit de symmetrie van een functie gevolgen afleiden voor functiewaarden, nulwaarden en andere bijzondere punten van de grafiek.
  
    \item Je kunt bij het onderzoeken van evenheid en onevenheid rekening houden met het domein van de functie.
  
    \item Je kunt symmetrie doelgericht gebruiken om de kenmerken en het gedrag van een functie efficiënter te analyseren.
