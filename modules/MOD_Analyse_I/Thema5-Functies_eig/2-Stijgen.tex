...
\begin{voorkennis}
  ...
  \item Je kunt het domein en bereik van een functie bepalen en interpreteren.

  \item Je kunt nulwaarden en het tekenverloop van een functie uit een grafiek aflezen.

  \item Je kunt functiewaarden met elkaar vergelijken.

  \item Je kunt intervallen correct lezen en noteren.

\end{voorkennis}

\begin{leerdoelen}

  \item Je kunt uit een grafiek bepalen op welke intervallen een functie stijgt, daalt of constant is.

  \item Je kunt stijgen, dalen en constant zijn beschrijven door functiewaarden met elkaar te vergelijken.

  \item Je kunt lokale en globale maxima en minima in een grafiek herkennen en correct benoemen.

  \item Je kunt het onderscheid uitleggen tussen een extremumplaats, een extremumwaarde en het bijbehorende extremumpunt.

  \item Je kunt het verloop van een functie beschrijven en deze informatie overzichtelijk weergeven in een verlooptabel.

  \item Je kunt vanuit gegeven informatie over stijgen, dalen en extrema een mogelijke grafiek construeren.

  \item Je kunt stijgen, dalen en extrema interpreteren binnen een betekenisvolle context en je conclusies terugkoppelen naar de oorspronkelijke situatie.

  \item Je kunt GeoGebra doelgericht gebruiken om het verloop en de extrema van een functie te onderzoeken en vermoedens te controleren.
