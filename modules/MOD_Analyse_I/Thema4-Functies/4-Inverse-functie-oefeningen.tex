...
\FVDsection{Basis — noodzakelijke begrippen en technieken}
...
\FVDsection{Verdieping — grafisch analyseren}
...
\FVDsection{Gevorderd — redeneren, transfer en modellering}
...
\FVDsection{Minimumcontrole — beheers je de inverse functie?}

\begin{opmerking}
De oefeningen met \textbf{\(\blacklozenge\) Essentieel} vormen samen de
minimale beheersingskern.

Je moet zonder hulp kunnen uitleggen en grafisch analyseren waarom
\[
(a,b)\leftrightarrow(b,a)
\]
leidt tot spiegeling in \(y=x\), domein en bereik correct kunnen verwisselen,
een eenvoudige inverse kunnen bepalen en controleren, en herkennen wanneer
eerst een domeinbeperking noodzakelijk is.

Daarmee is de algemene basis voor inverse functies gelegd. De expliciet in
het leerplan vermelde cyclometrische functies worden later afgewerkt in
samenhang met de goniometrische functies.
\end{opmerking}
