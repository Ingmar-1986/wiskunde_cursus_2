...
\else
  \FVDmoduleopening
    ...
    \FVDmodulethemetile{3}{Afleiden van samengestelde functie}
    \FVDmodulethemetile{4}{Functies met breuken en wortels}
    \FVDmodulethemetile{5}{Groei,verval en logaritmen}
    \FVDmodulethemetile{6}{Golven en periodiciteit}
    \FVDmodulethemetile{7}{Omgekeerde functies}
    \FVDmodulethemetile{8}{Integralen begrijpen}
    \FVDmodulethemetile{9}{Integreren met strategie}
    }
\fi
